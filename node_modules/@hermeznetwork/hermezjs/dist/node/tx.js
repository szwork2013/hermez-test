...
var deposit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(amount, hezEthereumAddress, token, babyJubJub, signerData, providerUrl) {
    var gasLimit,
        gasMultiplier,
        ethereumAddress,
        txSignerData,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            hermezContract = (0, _contracts.getContract)(_constants.contractAddresses.Hermez, _HermezABI.default, txSignerData, providerUrl);
            _context.next = 7;
          ...
          case 18:
            _context.next = 20;
            return (0, _tokens.approve)(amount, ethereumAddress, token.ethereumAddress, signerData, providerUrl);
...
var forceExit = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(amount, accountIndex, token, signerData, providerUrl) {
    var gasLimit,
        gasMultiplier,
        account,
        ethereumAddress,
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            signerData = _args3.length > 7 ? _args3[7] : undefined;
            providerUrl = _args3.length > 8 ? _args3[8] : undefined;
...
var delayedWithdraw = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(hezEthereumAddress, token, signerData, providerUrl) {
    var gasLimit,
        gasMultiplier,
        ethereumAddress,
        txSignerData,
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            delayedWithdrawalContract = (0, _contracts.getContract)(_constants.contractAddresses.WithdrawalDelayer, _WithdrawalDelayerABI.default, txSignerData, providerUrl);
