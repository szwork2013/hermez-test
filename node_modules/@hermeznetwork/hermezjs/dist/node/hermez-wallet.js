          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                messageHex = _ethers.ethers.utils.hexlify(accountCreationAuthMsgArray) + this.publicKeyCompressedHex + _ethers.ethers.utils.hexZeroPad(chainIdHex, 2).slice(2) + (0, _addresses.getEthereumAddress)(this.hermezEthereumAddress).slice(2);
              ...
              case 11:
                ...
                return _context.abrupt("return", signatureParams.r + signatureParams.s + signatureParams.v);
