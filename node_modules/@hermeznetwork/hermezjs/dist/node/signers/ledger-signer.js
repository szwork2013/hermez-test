...
var LedgerSigner = /*#__PURE__*/function (_ethers$Signer) {
  ...
  _createClass(LedgerSigner, [{
    ...
    value: function getAddress() {
      return this.eth.getAddress(this.path).then(_ethers.ethers.utils.getAddress);
    }
    /**
    ...
    value: function signMessage(message) {
      ...
      return this.eth.signPersonalMessage(this.path, messageHex).then(function (result) {
    ...
    value: function signTransaction(transaction) {
      ...
      return _ethers.ethers.utils.resolveProperties().then(function (tx) {
        ...
        return _this2.eth.signTransaction(_this2.path, unsignedTx).then(function (_ref) {
          var r = _ref.r,
              s = _ref.s,
              v = _ref.v;
          var signature = {
    ...
    value: function connect(provider, options) {
      return _hwTransportU2f.default.create().then(function (transport) {
