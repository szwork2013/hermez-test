...
var TrezorSigner = /*#__PURE__*/function (_ethers$Signer) {
  ...
  function TrezorSigner(provider, options) {
    ...
    _this.address = options && options.address;

    _trezorConnect.default.manifest(options && options.manifest);
  ...
  _createClass(TrezorSigner, [{
    ...
    key: "signTransaction",
    value: function signTransaction(transactionData) {
      var transaction = {
        ...
        nonce: _ethers.ethers.utils.hexlify(transactionData.nonce),
      ...
      return _trezorConnect.default.ethereumSignTransaction({
        ...
        if (!result.success) {
          ...
          return _ethers.ethers.utils.serializeTransaction(transaction, signature);
        }
      });
    }
    /**
