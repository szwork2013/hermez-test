...
exports.hasCryptoCurrencyId = exports.findCryptoCurrencyByKeyword = void 0;
 ...
 */
const makeTestnetUnit = u => _objectSpread(_objectSpread({}, u), {}, {
  code: `𝚝${u.code}`
});
...
const cryptocurrenciesById = {
  ...
  algorand: {
    ...
    explorerViews: [{
      tx: "https://goalseeker.purestake.io/algorand/mainnet/transaction/$hash"
    }]
  },
  ark: {
    type: "CryptoCurrency",
...
function listCryptoCurrencies(withDevCrypto = false, withTerminated = false) {
  return withTerminated ? withDevCrypto ? cryptocurrenciesArray : prodCryptoArray : withDevCrypto ? cryptocurrenciesArrayWithoutTerminated : prodCryptoArrayWithoutTerminated;
}
/**
 *
 * @param {*} f
...
const findCryptoCurrencyByKeyword = keyword => {
...
const hasCryptoCurrencyId = id => id in cryptocurrenciesById;
/**
 *
 * @param {*} id
 */
